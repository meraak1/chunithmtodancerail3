...
This is a converter that will convert UMIGURI (Chunithm) beatmaps to DanceRail3 charts. Only UMIGURI beatmaps (.ugc) are supported, but support for more formats might happen eventually.
